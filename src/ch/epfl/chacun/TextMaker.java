...
public interface TextMaker {
     ...
     * @return le texte du message
     */
    String playerScoredHuntingTrap(PlayerColor scorer, int points, TreeMap<Animal.Kind, Integer> animals);
     ...
     * @return le texte du message
     */
    String playersScoredMeadow(Set<PlayerColor> scorers, int points, TreeMap<Animal.Kind, Integer> animals);
     ...
     * @return le texte du message
     */
    String playersScoredPitTrap(Set<PlayerColor> scorers, int points, TreeMap<Animal.Kind, Integer> animals);
